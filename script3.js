...
const addAns = ["5 years", "supreme court", "elected MPs and MLAs", "a document outlining the laws of the land", "central government", "chief justice of India", "25 years", "president", "judiciary"]

const subQues = ["./pol/19.png",  "./pol/20.png",  "./pol/21.png",  "./pol/22.png",  "./pol/23.png",  "./pol/24.png",  "./pol/25.png",  "./pol/26.png",  "./pol/27.png"]

const subAns = ["president", "article 17", "1949", "equal representation for all", "election commission", "executive", "right to freedom", "interpret laws", "rule by one person"]

const mulQues = ["./pol/1.png",
    "./pol/2.png", 
    "./pol/3.png",  
    "./pol/4.png", 
    "./pol/5.png",  
...
const mulAns = ["rule by the people", "constitution", "legislative, judiciary, executive", "mayor", "to govern rural localities", "citizens of the constituency", "no discrimination based on religion", "right to freedom of religion", "parliament"]
...
const divAns = ["harappan", "central asia", "chandragupta maurya", "maurya", "pictographic script", "pataliputra", "bahadur shah zafar", "mongols", "ashoka"]
...
const addMulAns = ["battle of panipat", "chandragupta i", "razia sultan", "kautilya", "urban planning", "sanskrit", "1757", "bahadur shah zafar", "alexander the great"]
...
const addSubAns = ["vasco da gama", "qutb-ud-din aibak", "kanchipuram", "kautilya", "samudragupta", "raja ram mohan roy", "1919", "nana sahib", "delhi"]
...
const divMulAns = ["spherical", "nile", "asia", "australia", "pacific ocean", "equator", "venus", "nitrogen", "solar energy"]
...
const divSubAns = ["stratosphere", "ural mountains", "sahara desert", "volcanic", "damodar", "mount everest", "china", "rotation of the earth", "andes"]
...
const allAns = ["japan", "tokyo", "71%", "canberra", "silicon and oxygen", "antarctica", "united states and canada", "earth's revolution around the sun", "mantle"]
